...
| `BrowserSurface` ([26.2](../../packages/fabric-26.2/src/main/java/io/github/trethore/graphene/fabric/api/surface/BrowserSurface.java), [26.1.2](../../packages/fabric-26.1.2/src/main/java/io/github/trethore/graphene/fabric/api/surface/BrowserSurface.java), [1.21.11](../../packages/fabric-1.21.11/src/main/java/io/github/trethore/graphene/fabric/api/surface/BrowserSurface.java))                          | Own and render a browser session through a custom GUI path. |
| [`BrowserSurfaceInputAdapter`](../../packages/fabric-shared/src/main/java/io/github/trethore/graphene/fabric/api/surface/BrowserSurfaceInputAdapter.java)                                                                                                                                                                                                                                                           | Translate Minecraft and GLFW input for a custom surface.    |
