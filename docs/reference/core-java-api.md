...
| `BrowserSurface` ([26.2](../../packages/fabric-26.2/src/main/java/io/github/trethore/graphene/fabric/api/surface/BrowserSurface.java), [1.21.11](../../packages/fabric-1.21.11/src/main/java/io/github/trethore/graphene/fabric/api/surface/BrowserSurface.java))                    | Own and render a browser session through a custom GUI path. |
