...
|----------|--------|-----------|-------------|-----------------|---------------------------------------------|
| 2.3.0    | Fabric | 26.2      | 25 or newer | 0.19.3 or newer | 0.158.0+26.2 or newer compatible release    |
| 2.3.0    | Fabric | 26.1.2    | 25 or newer | 0.19.3 or newer | 0.155.2+26.1.2 or newer compatible release  |
| 2.3.0    | Fabric | 1.21.11   | 21 or newer | 0.19.3 or newer | 0.141.6+1.21.11 or newer compatible release |
...
dependencies {
    implementation("io.github.trethore:graphene-ui-26.2:2.3.0")
    // Or for Minecraft 26.1.2:
    // implementation("io.github.trethore:graphene-ui-26.1.2:2.3.0")
    // Or for Minecraft 1.21.11:
    // modImplementation("io.github.trethore:graphene-ui-1.21.11:2.3.0")
}
```
