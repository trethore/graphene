...
final class GrapheneDebugTestRunner {
    ...
    static CompletableFuture<String> runAllTestsAsJson() {
        ...
        return onClientThread(GrapheneDebugTestRunner::runTests).handle((results, failure) -> {
            ...
            report.addProperty(
                    "ok",
                    failure == null && results != null && results.stream().allMatch(GrapheneDebugTestRunner::passed));
            if (failure != null) {
