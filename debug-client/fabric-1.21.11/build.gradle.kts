...
val grapheneDevelopmentJar = grapheneProject.tasks.named<Jar>("jar").flatMap { it.archiveFile }
...
dependencies {
  ...
  compileOnly(project(":packages:common"))
  runtimeOnly(project(":packages:common"))
