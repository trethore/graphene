...
public final class GrapheneInputBridge {
    ...
    public void mouseMoved(GrapheneBrowser browser, int x, int y, int modifiers) {
    ...
    public void mouseDragged(GrapheneBrowser browser, double x, double y, int button) {
    ...
    public void mouseInteracted(GrapheneBrowser browser, int x, int y, int modifiers, int button, boolean pressed, int clickCount) {
    ...
    public void mouseScrolled(GrapheneBrowser browser, int x, int y, int modifiers, int amount, int rotation) {
        int cefModifiers = toCefMouseModifiers(modifiers);
