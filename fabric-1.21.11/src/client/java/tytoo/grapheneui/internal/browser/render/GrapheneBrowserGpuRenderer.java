...
public final class GrapheneBrowserGpuRenderer implements AutoCloseable {
    ...
    private final GrapheneScreenshotRenderer screenshotRenderer;

    public GrapheneBrowserGpuRenderer(boolean transparent) {
        this.frameUploader = new GrapheneBrowserFrameUploader(transparent);
        this.screenshotRenderer = new GrapheneScreenshotRenderer(transparent);
    }

    public void render(
            GuiGraphics guiGraphics,
            GraphenePaintSnapshot snapshot,
            int x,
            int y,
            int width,
            int height,
    ...
    public CompletableFuture<BufferedImage> createScreenshot(GraphenePaintSnapshot snapshot) {
        return screenshotRenderer.createScreenshot(snapshot);
    }
