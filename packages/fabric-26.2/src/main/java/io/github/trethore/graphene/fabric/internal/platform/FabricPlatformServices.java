...
public final class FabricPlatformServices {
    ...
    private static BrowserJsDialogPresenter.Result showMessageDialog(
        ...
        int response = TinyFileDialogs.tinyfd_messageBox(
                title, message, alert ? "ok" : "yesno", alert ? "info" : "question", 1);
        return response != 0 ? BrowserJsDialogPresenter.Result.accept() : BrowserJsDialogPresenter.Result.cancel();
    }
}
