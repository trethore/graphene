...
final class TinyFdFileDialogFilterTest {
    ...
    void flattensExpandedExtensionsAndDescriptions() {
        TinyFdFileDialogFilter filter = TinyFdFileDialogFilter.from(List.of(
    ...
    void usesCombinedFilterPatternAsFallback() {
        TinyFdFileDialogFilter filter = TinyFdFileDialogFilter.from(
    ...
    void ignoresMimeTypesWithoutExpandedExtensions() {
        TinyFdFileDialogFilter filter =
                TinyFdFileDialogFilter.from(List.of(new BrowserFileDialogPresenter.Filter("image/*", "", "Images")));
