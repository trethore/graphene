...
final class GrapheneCefJsDialogHandler extends CefJSDialogHandlerAdapter {
    ...
    GrapheneCefJsDialogHandler(BrowserJsDialogPresenter defaultPresenter, GrapheneTaskExecutor mainThreadExecutor) {
    ...
    public boolean onJSDialog(
        ...
        BrowserJsDialogPresenter.Request request = new BrowserJsDialogPresenter.Request(
        ...
        mainThreadExecutor
                ...
                .whenComplete((result, failure) -> mainThreadExecutor.execute(() -> {
    ...
    public boolean onBeforeUnloadDialog(
        ...
        mainThreadExecutor
                .supplyStage(() -> presenter.show(request))
                .whenComplete((result, failure) -> mainThreadExecutor.execute(
                        () -> callback.Continue(failure == null && result != null && result.accepted(), "")));
        return true;
    }
    ...
    private static BrowserJsDialogPresenter.Type dialogType(CefJSDialogHandler.JSDialogType dialogType) {
        if (dialogType == null) {
