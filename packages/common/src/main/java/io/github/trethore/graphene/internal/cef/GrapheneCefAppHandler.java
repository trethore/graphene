...
final class GrapheneCefAppHandler extends MavenCefAppHandlerAdapter {
    private static final String READ_GUARD = "profile.default_content_setting_values.file_system_read_guard";
    private static final String WRITE_GUARD = "profile.default_content_setting_values.file_system_write_guard";
    ...
    public synchronized void onRegisterCustomSchemes(CefSchemeRegistrar registrar) {
        ...
        registrar.addCustomScheme(GrapheneAppUrls.SCHEME, standardAppScheme, false, false, true, true, false, true);
        registrar.addCustomScheme(GrapheneClasspathUrls.SCHEME, false, false, false, false, false, false, false);
    }
