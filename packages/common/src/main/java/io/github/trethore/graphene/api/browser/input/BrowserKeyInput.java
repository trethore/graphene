...
public record BrowserKeyInput(
    ...
    public BrowserKeyInput(
            BrowserKeyAction action, BrowserKey key, BrowserKeyLocation location, Set<BrowserModifier> modifiers) {
    ...
    public BrowserKeyInput(
        ...
        this(action, key, location, modifiers, Optional.of(Objects.requireNonNull(rawMetadata, "rawMetadata")));
    }
}
