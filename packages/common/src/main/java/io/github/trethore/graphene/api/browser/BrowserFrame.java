...
public final class BrowserFrame {
    ...
    public BrowserFrame(
            int width, int height, long sequence, List<BrowserDirtyRegion> dirtyRegions, ByteBuffer pixels) {
        if (width <= 0 || height <= 0) {
        ...
        List<BrowserDirtyRegion> validatedDirtyRegions = validateDirtyRegions(width, height, dirtyRegions);
