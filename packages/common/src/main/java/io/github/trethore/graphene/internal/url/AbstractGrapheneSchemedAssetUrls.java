...
abstract class AbstractGrapheneSchemedAssetUrls extends AbstractGrapheneAssetUrls {
    ...
    private String normalizeAssetResourcePath(URI uri) {
        ...
        return resourcePath(AssetId.normalizeNamespace(host), normalizeDecodedResourcePath(decodedPath));
    }
    ...
    private String normalizeAssetsPath(String path) {
        ...
        String assetPath = normalizeDecodedResourcePath(normalizedPath.substring(namespaceSeparator + 1));
