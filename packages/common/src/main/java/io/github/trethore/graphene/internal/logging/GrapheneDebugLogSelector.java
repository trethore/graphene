package io.github.trethore.graphene.internal.logging;
...
public final class GrapheneDebugLogSelector {
  ...
  private static final GrapheneDebugLogSelector ACTIVE_SELECTOR =
      fromRawSelector(System.getProperty(PROPERTY_NAME));
  ...
  boolean matches(String classOrPackageName) {
    ...
    for (String packagePrefix : packagePrefixes) {
      if (classOrPackageName.equals(packagePrefix)
          || classOrPackageName.startsWith(packagePrefix + ".")) {
        return true;
      }
    }
