...
public final class GrapheneGlobalConfig {
    ...
    private GrapheneGlobalConfig(Builder builder) {
        this.browserRuntimePath = builder.browserRuntimePath == null
                ? null
                : normalizePath(builder.browserRuntimePath, BROWSER_RUNTIME_PATH_NAME);
        this.extensionFolders =
                List.copyOf(builder.extensionFolders.stream().sorted().toList());
    ...
    @Override
    public int hashCode() {
        return Objects.hash(browserRuntimePath, extensionFolders, remoteDebugConfig, browserFileAccessPolicy);
    }
    ...
    public static final class Builder {
        ...
        public Builder browserRuntimePath(String browserRuntimePath) {
            return browserRuntimePath(Path.of(Objects.requireNonNull(browserRuntimePath, BROWSER_RUNTIME_PATH_NAME)));
        }
