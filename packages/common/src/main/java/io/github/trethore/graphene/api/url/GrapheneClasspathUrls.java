...
public final class GrapheneClasspathUrls {
    ...
    private static final GrapheneClasspathUrlsSupport SUPPORT = new GrapheneClasspathUrlsSupport("grapheneui");
    ...
    private static final class GrapheneClasspathUrlsSupport implements GrapheneAssetUrls {
        ...
        private String normalizeResourcePath(String url) {
            try {
                ...
                String decodedPath =
                        URLDecoder.decode(uri.getRawPath() == null ? "" : uri.getRawPath(), StandardCharsets.UTF_8);
