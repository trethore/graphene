...
public final class Graphene {
    private static final GrapheneRuntimeController RUNTIME_CONTROLLER = GrapheneRuntimeController.instance();
    private static final GrapheneContextFactory CONTEXT_FACTORY = parameters -> new GrapheneContext(
            parameters.id(),
            parameters.config(),
