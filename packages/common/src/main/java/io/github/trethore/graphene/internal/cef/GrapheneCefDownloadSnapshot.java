...
record GrapheneCefDownloadSnapshot(
        Metadata metadata, BrowserDownloadState state, Path target, Progress progress, BrowserDownloadControl control)
    ...
    record Metadata(
            BrowserDownloadId id, String url, String suggestedFileName, String mimeType, String contentDisposition) {}
