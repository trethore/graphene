...
final class GrapheneCefContextMenuMapper {
    ...
    static BrowserContextMenuContext context(BrowserSession session, CefContextMenuParams params) {
        ...
        return new BrowserContextMenuContext(
                ...
                new BrowserContextMenuContext.Document(
                        string(params.getPageUrl()), string(params.getFrameUrl()), string(params.getFrameCharset())),
                ...
                new BrowserContextMenuContext.Editing(
                        ...
                        suggestions.stream()
                                .map(GrapheneCefContextMenuMapper::string)
                                .toList()));
    }
    ...
    static BrowserContextMenuAction action(int commandId) {
        return switch (commandId) {
            ...
            case CefMenuModel.MenuId.MENU_ID_RELOAD_NOCACHE -> BrowserContextMenuAction.RELOAD_WITHOUT_CACHE;
    ...
    private static BrowserContextMenuContext.MediaType mediaType(CefContextMenuParams.MediaType mediaType) {
        if (mediaType == null) {
