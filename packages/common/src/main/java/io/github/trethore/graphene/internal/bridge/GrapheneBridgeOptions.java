...
public final class GrapheneBridgeOptions {
  ...
  private static final GrapheneBridgeQueueOverflowPolicy DEFAULT_QUEUE_OVERFLOW_POLICY =
  ...
  private GrapheneBridgeOptions(Builder builder) {
    ...
    Duration validatedTimeout =
        Objects.requireNonNull(builder.defaultRequestTimeout, "defaultRequestTimeout");
    ...
    this.queueOverflowPolicy =
        Objects.requireNonNull(builder.queueOverflowPolicy, "queueOverflowPolicy");
  ...
  public static final class Builder {
    ...
    public Builder defaultRequestTimeout(Duration defaultRequestTimeout) {
      this.defaultRequestTimeout =
          Objects.requireNonNull(defaultRequestTimeout, "defaultRequestTimeout");
      return this;
    }
