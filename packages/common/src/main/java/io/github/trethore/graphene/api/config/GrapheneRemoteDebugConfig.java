...
public final class GrapheneRemoteDebugConfig {
  ...
  private static final GrapheneRemoteDebugConfig DISABLED =
      GrapheneRemoteDebugConfig.builder().disable().build();
  ...
  private GrapheneRemoteDebugConfig(Builder builder) {
    ...
    this.allowedOrigins =
        builder.allowedOrigins == null ? null : normalizeAllowedOrigins(builder.allowedOrigins);
  }
  ...
  private static String normalizeAllowedOrigins(String allowedOrigins) {
    String normalizedAllowedOrigins =
        Objects.requireNonNull(allowedOrigins, "allowedOrigins").trim();
