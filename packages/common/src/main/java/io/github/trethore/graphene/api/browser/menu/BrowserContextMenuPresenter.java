...
public interface BrowserContextMenuPresenter {
    ...
    record Result(Optional<BrowserContextMenuItem.CommandId> selectedCommand, Set<BrowserModifier> modifiers) {
        public Result {
        ...
        public static Result select(BrowserContextMenuItem.Command command, Set<BrowserModifier> modifiers) {
            return new Result(
                    Optional.of(Objects.requireNonNull(command, "command").id()), modifiers);
        }
