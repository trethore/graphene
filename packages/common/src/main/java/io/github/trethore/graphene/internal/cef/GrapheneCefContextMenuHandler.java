...
final class GrapheneCefContextMenuHandler extends CefContextMenuHandlerAdapter {
    ...
    private void present(
        ...
        BrowserContextMenuPresenter.Request request = new BrowserContextMenuPresenter.Request(context, configuredItems);
        mainThreadExecutor
    ...
    private static void complete(
        ...
        if (failure != null
                || result == null
                || sessionClosed
                || result.selectedCommand().isEmpty()) {
            callback.Cancel();
            return;
        }
    ...
    private static BrowserContextMenuItem.Command snapshotCommand(
        ...
        BrowserContextMenuItem.CommandId commandId = new BrowserContextMenuItem.CommandId(commands.size() + 1L);
