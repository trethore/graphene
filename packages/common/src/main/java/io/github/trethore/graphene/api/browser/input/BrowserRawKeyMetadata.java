 ...
 */
public record BrowserRawKeyMetadata(BrowserKeyPlatform platform, long scanCode, int layoutCodePoint) {
    public BrowserRawKeyMetadata {
        ...
        if (layoutCodePoint != 0
            ...
            throw new IllegalArgumentException("layoutCodePoint must be zero or a valid Unicode code point");
        }
    }
}
