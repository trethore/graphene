...
final class GrapheneBridgeJsonApiTest {
    ...
    void requestJsonSerializesRequestAndParsesResponse() {
        ...
        SumResponse response = bridge.requestJson(REQUEST_CHANNEL, new SumRequest(6, 4), SumResponse.class)
                .join();
    ...
    void onEventJsonParsesPayload() {
        ...
        try (GrapheneSubscription ignoredSubscription = bridge.onEventJson(
                EVENT_CHANNEL, BridgeEvent.class, (ignoredChannel, payload) -> payloadRef.set(payload))) {
    ...
    void onRequestJsonParsesRequestAndSerializesResponse() {
        TestBridge bridge = new TestBridge();
        try (GrapheneSubscription ignoredSubscription = bridge.onRequestJson(
                REQUEST_CHANNEL,
                SumRequest.class,
    ...
    void onEventJsonFailsFastForMalformedPayload() {
        ...
        try (GrapheneSubscription ignoredSubscription =
                bridge.onEventJson(EVENT_CHANNEL, BridgeEvent.class, (ignoredChannel, ignoredPayload) -> {})) {
