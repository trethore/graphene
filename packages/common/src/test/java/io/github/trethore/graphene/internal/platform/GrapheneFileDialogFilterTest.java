...
final class GrapheneFileDialogFilterTest {
    @Test
    void flattensExpandedExtensionsAndDescriptions() {
        GrapheneFileDialogFilter filter = GrapheneFileDialogFilter.from(List.of(
    ...
    void usesCombinedFilterPatternAsFallback() {
        GrapheneFileDialogFilter filter = GrapheneFileDialogFilter.from(
    ...
    void ignoresMimeTypesWithoutExpandedExtensions() {
        GrapheneFileDialogFilter filter =
                GrapheneFileDialogFilter.from(List.of(new BrowserFileDialogPresenter.Filter("image/*", "", "Images")));
