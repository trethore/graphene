...
final class GrapheneAppUrlsTest {
    @Test
    void buildsAppUrls() {
        assertEquals("app://assets/my-mod/web/index.html", GrapheneAppUrls.url("my-mod", "/web/index.html"));
        assertEquals("app://assets/my-mod/web/index.html", GrapheneAppUrls.url(AssetId.of("my-mod", "web/index.html")));
        assertEquals(
                "app://assets/my-mod/index.html",
                GrapheneAppUrls.assets("my-mod").url("index.html"));
    }
    ...
    void rejectsUnsupportedAndUnsafeResourceUrls() {
        ...
        assertEquals("", GrapheneAppUrls.normalizeResourcePath("app://assets/my-mod/%2e%2e/secret.txt"));
    }
}
