...
final class GrapheneClasspathUrlsTest {
    ...
    void buildsClasspathUrls() {
        ...
        assertEquals(
                "classpath:///assets/my-mod/web/index.html", GrapheneClasspathUrls.url("my-mod", "/web/index.html"));
        assertEquals(
    ...
    void normalizesClasspathResourceUrls() {
        assertEquals(
                ...
                GrapheneClasspathUrls.normalizeResourcePath("classpath:///assets/my-mod/web/a%20b.html?x=1#section"));
        ...
        assertEquals("", GrapheneClasspathUrls.normalizeResourcePath("classpath:///assets/my-mod/%2e%2e/secret.txt"));
    }
}
