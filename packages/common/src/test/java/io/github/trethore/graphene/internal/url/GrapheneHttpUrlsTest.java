...
final class GrapheneHttpUrlsTest {
    ...
    void buildsAssetAndMountedUrls() {
        ...
        assertEquals("http://127.0.0.1:20000/mods/my-mod/web/index.html", urls.modUrl("my-mod", "/web/index.html"));
    }
    ...
    void rejectsUnavailableServerAndUnsafePaths() {
        ...
        assertThrows(IllegalArgumentException.class, () -> availableUrls.modUrl("my-mod", "../secret.txt"));
    }
}
