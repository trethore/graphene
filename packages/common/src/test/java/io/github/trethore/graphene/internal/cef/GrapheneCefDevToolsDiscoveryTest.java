...
class GrapheneCefDevToolsDiscoveryTest {
    ...
    void queriesTheRemoteDiscoveryEndpoint() throws IOException {
        ...
        try {
            List<DevToolsPageTarget> targets = GrapheneCefDevToolsDiscovery.pageTargets(
    ...
    void parsesPageTargetsAndResolvesInspectorUris() {
        ...
        List<DevToolsPageTarget> targets = GrapheneCefDevToolsDiscovery.parsePageTargets(response, DISCOVERY_URI);
    ...
    void reportsMissingAndAmbiguousSessionMatches() {
        ...
        DevToolsTargetAmbiguousException ambiguousException = assertThrows(
