...
public final class GrapheneMouseHandlerHook {
    ...
    public static boolean handleMouseClick(Screen screen, MouseButtonEvent event, boolean doubleClick) {
        if (screen instanceof GrapheneScreenBridgeSupport bridge && bridge.graphene$handleContextMenuClick(event)) {
            return true;
        }
    ...
    public static boolean handleMouseRelease(Screen screen, MouseButtonEvent event) {
        if (screen instanceof GrapheneScreenBridgeSupport bridge && bridge.graphene$handleContextMenuRelease(event)) {
            return true;
        }
    ...
    public static boolean handleMouseScroll(
        ...
        if (screen instanceof GrapheneScreenBridgeSupport bridge && bridge.graphene$isContextMenuOpen()) {
            return true;
        }
