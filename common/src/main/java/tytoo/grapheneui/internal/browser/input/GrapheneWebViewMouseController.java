...
final class GrapheneWebViewMouseController {
    private final GrapheneMouseInputTarget browser;
    ...
    GrapheneWebViewMouseController(GrapheneMouseInputTarget browser, GrapheneFocusUtil focusUtil, GrapheneBridge bridge) {
