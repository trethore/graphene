...
public final class GrapheneDomKeyboardDispatcher {
    ...
    private final GrapheneInputLockState lockState;
    private final IntUnaryOperator modifierResolver;
    ...
    public GrapheneDomKeyboardDispatcher(BiConsumer<String, JsonObject> devToolsMethodExecutor) {
        this(devToolsMethodExecutor, GrapheneInputLockState::defaultWindowHandle);
    }

    public GrapheneDomKeyboardDispatcher(
            BiConsumer<String, JsonObject> devToolsMethodExecutor,
            LongSupplier windowHandleSupplier
    ) {
        this(devToolsMethodExecutor, windowHandleSupplier, GrapheneInputModifierUtil::mergeWithCurrentModifiers);
    }

    GrapheneDomKeyboardDispatcher(
            BiConsumer<String, JsonObject> devToolsMethodExecutor,
            LongSupplier windowHandleSupplier,
            IntUnaryOperator modifierResolver
    ) {
        this.devToolsMethodExecutor = Objects.requireNonNull(devToolsMethodExecutor, "devToolsMethodExecutor");
        this.lockState = new GrapheneInputLockState(windowHandleSupplier);
        this.modifierResolver = Objects.requireNonNull(modifierResolver, "modifierResolver");
    }
    ...
    public void keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        int resolvedModifiers = modifierResolver.applyAsInt(modifiers);
