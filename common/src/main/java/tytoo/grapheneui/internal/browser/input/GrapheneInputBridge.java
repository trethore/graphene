...
public final class GrapheneInputBridge {
    ...
    public void mouseMoved(GrapheneCefMouseTarget browser, int x, int y, int modifiers) {
    ...
    public void mouseDragged(GrapheneCefMouseTarget browser, double x, double y, int button) {
    ...
    public void mouseInteracted(GrapheneCefMouseTarget browser, int x, int y, int modifiers, int button, boolean pressed, int clickCount) {
    ...
    public void mouseScrolled(GrapheneCefMouseTarget browser, int x, int y, int modifiers, int amount, int rotation) {
        int cefModifiers = toCefMouseModifiers(modifiers);
