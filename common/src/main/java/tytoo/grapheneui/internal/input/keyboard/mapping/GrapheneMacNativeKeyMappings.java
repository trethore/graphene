...
final class GrapheneMacNativeKeyMappings {
    ...
    private static final Map<Integer, Integer> MAC_NATIVE_KEY_CODES_BY_GLFW = createValueByFirstColumn(MAC_NATIVE_FROM_GLFW);
    ...
    private static final Map<Integer, Integer> MAC_NATIVE_KEY_CODES_BY_CHARACTER = createValueByFirstColumn(MAC_NATIVE_FROM_CHARACTER);

    private GrapheneMacNativeKeyMappings() {
    }
    ...
    static boolean hasGlfwMapping(int keyCode) {
    ...
    static boolean hasCharacterMapping(char character) {
        return MAC_NATIVE_KEY_CODES_BY_CHARACTER.containsKey((int) character);
    }

    private static Map<Integer, Integer> createValueByFirstColumn(int[][] mappingRows) {
