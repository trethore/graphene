...
public final class GrapheneBridgeEndpoint implements GrapheneBridge {
    ...
    private final GrapheneBridgeBrowser browser;
    ...
    public GrapheneBridgeEndpoint(GrapheneBridgeBrowser browser) {
        this(browser, GrapheneBridgeOptions.defaults(), GrapheneMainThreadExecutor.DIRECT);
    }

    GrapheneBridgeEndpoint(
            GrapheneBridgeBrowser browser,
        ...
        this.inboundRouter = new GrapheneBridgeInboundRouter(
                codec,
                handlers,
                requestLifecycle,
                this::onBridgeReady,
